...
if escolher == produtos[0]:
    ...
    custo_total = valor_gasto[0] * hectares
    print(f"O custo total por hectare é equivalente a: {custo_total}")
    ...
    custo_total = valor_gasto[1] * hectares
    print(f"O custo total por hectare é equivalente a: {custo_total}")
    ...
    custo_total = valor_gasto[2] * hectares
    print(f"O custo total por hectare é equivalente a: {custo_total}")
    ...
    custo_total = valor_gasto[3] * hectares
    print(f"O custo total por hectare é equivalente a: {custo_total}")
    ...
    custo_total = valor_gasto[4] * hectares
    print(f"O custo total por hectare é equivalente a: {custo_total}")
